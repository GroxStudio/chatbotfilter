...
bad_words = 'сука', 'хуй', 'пздц', 'пиздец', 'хуёк', 'бля', 'блядь', 'блять', 'блядина', 'шалава', 'шлюха', 'пидорас', 'pidor', 'пидор', 'хуйня', 'хуила', 'пидрилла', 'пидр', 'пидрила', 'соси', 'соси хуй', 'гандон', 'хуй соси', 'долбаёб', 'долбоёб', 'пизда', 'соси пизду', 'пизду', 'пиздуй'
